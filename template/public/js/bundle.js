(function(Alpine2) {
  "use strict";
  var _a;
  const _ReloadStateStore = class _ReloadStateStore {
    capture() {
      const stateMap = {};
    ...
    restore() {
      ...
      try {
        ...
        console.warn("Could not restore Alpine state", e2);
      }
    }
  };
  _ReloadStateStore.NAME = "reloadState";
  let ReloadStateStore = _ReloadStateStore;
  const stores = {
